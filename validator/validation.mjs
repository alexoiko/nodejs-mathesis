...
const validateNewComment = [
    body("newComment") //έλεγχος εγκυρότητας για τo σχόλιο
    ...
    (req, res, next) => {
        ...
        if (errors.isEmpty()) {
            ...
            res.render("addcommentform", {
                message: errors.mapped(), // περιγραφές των σφαλμάτων εγκυρότητας
                comment: req.body["newComment"], // η τιμή που έδωσε ο χρήστης
            })
        }
    }
]
...
export { validateLogin, validateNewBook, validateNewComment, validateNewUser }