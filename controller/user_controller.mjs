...
const doLogin = async (req, res, next) => {
    ...
    if (user) {
        ...
        req.session.password = req.body.password //τα μέλη του res.locals είναι απευθείας προσβάσιμα στο template
        next() //το επόμενο middleware είναι το showBooklist
    }
    else {
        //res.redirect("/")
        res.render("home", { wrongcredentials: "Λάθος στοιχεία πρόσβασης" })
    }
}
